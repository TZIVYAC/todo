...
export default connect(mapStateToProps)(function ShowTaskList(props) {
    ...
    const [tasksContact, setTasksContact] = useState([]);
    ...
    return (
        <>
            <React.Fragment>
                {tasksContact.length > 0 && tasksContact.map((item) => {
                    return (
                        <>
                            <TaskData id={item.taskId} tasksContact={tasksContact} />
                        </>
                    )
                })}
